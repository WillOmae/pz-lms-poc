...
public class DbHelper {
    ...
    private List<PermissionEntity> initPermissions() {
        List<String> entities = List.of("ROLES", "USERS", "ACCOUNTS", "ACCOUNT_BALANCES", "ACCOUNT_STATUSES", "ACCOUNT_TYPES", "CURRENCIES", "PARTNER_ACCOUNTS", "CREDENTIALS", "LOGIN_ATTEMPTS", "TRANSACTION_TYPES", "TRANSACTIONS", "TRANSACTION_ENTRIES", "REASON_TYPES", "LOAN_PRODUCTS");
