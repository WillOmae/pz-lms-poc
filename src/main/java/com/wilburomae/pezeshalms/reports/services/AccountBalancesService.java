...
public class AccountBalancesService {
    ...
    public AccountBalancesService(AccountBalancesRepository accountBalancesRepository) {
    ...
    public Response<AccountBalances> query(Params params) {
        ...
        List<CurrencyBalance> data = accountBalancesRepository.query(accountId, before);
